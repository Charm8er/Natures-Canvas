...
//        simpleBlockItem(NCBlocks.BLACK_SAND.get(), itemModels().withExistingParent("black_sand", "caliber:block/black_sand"));
    ...
    private void treeBlocks() {
        ...
        saplingBlock(NCBlocks.REDWOOD_SAPLING);
        logBlock((RotatedPillarBlock) NCBlocks.REDWOOD_LOG.get());
        axisBlock((RotatedPillarBlock) NCBlocks.STRIPPED_REDWOOD_LOG.get(), blockTexture(NCBlocks.STRIPPED_REDWOOD_LOG.get()), new ResourceLocation(NaturesCanvas.MOD_ID, "block/redwood_log_top"));
        axisBlock(((RotatedPillarBlock) NCBlocks.REDWOOD_WOOD.get()), blockTexture(NCBlocks.REDWOOD_LOG.get()), blockTexture(NCBlocks.REDWOOD_LOG.get()));
        axisBlock(((RotatedPillarBlock) NCBlocks.STRIPPED_REDWOOD_WOOD.get()), blockTexture(NCBlocks.STRIPPED_REDWOOD_LOG.get()), blockTexture(NCBlocks.STRIPPED_REDWOOD_LOG.get()));
        blockItem(NCBlocks.REDWOOD_LOG);
        blockItem(NCBlocks.STRIPPED_REDWOOD_LOG);
        blockItem(NCBlocks.REDWOOD_WOOD);
        blockItem(NCBlocks.STRIPPED_REDWOOD_WOOD);
        leavesBlock(NCBlocks.REDWOOD_LEAVES);
    }
