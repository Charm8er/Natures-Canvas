...
//        this.dropSelf(NCBlocks.FARMLAND_LAYER.get());
    ...
    private void treeBlocks() {
        ...
        this.dropSelf(NCBlocks.REDWOOD_SAPLING.get());
        this.dropSelf(NCBlocks.REDWOOD_LOG.get());
        this.dropSelf(NCBlocks.STRIPPED_REDWOOD_LOG.get());
        this.dropSelf(NCBlocks.REDWOOD_WOOD.get());
        this.dropSelf(NCBlocks.STRIPPED_REDWOOD_WOOD.get());
        this.dropSelf(NCBlocks.REDWOOD_LEAVES.get());
    }
