...
public class NCBiomes {
    ...
    public static final ResourceKey<Biome> REDWOOD_FOREST_BIOME = registerOverworld("redwood_forest_biome");
    ...
    public static void bootstrap(BootstapContext<Biome> context) {
        ...
        registerBiome(context, REDWOOD_FOREST_BIOME, NCOverworldBiomes.redwoodForest(placedFeatureGetter, carverGetter));
