...
public class NCVegetationPlacement {
    ...
    public static final ResourceKey<PlacedFeature> TREES_REDWOOD_FOREST = NCPlacementUtils.registerKey("trees_redwood_forest");
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        final Holder<ConfiguredFeature<?, ?>> TREES_REDWOOD_FOREST = configuredFeatureGetter.getOrThrow(NCVegetationFeatures.TREES_REDWOOD_FOREST);
        ...
        register(context, NCVegetationPlacement.TREES_REDWOOD_FOREST, TREES_REDWOOD_FOREST, treePlacement(PlacementUtils.countExtra(12, 0.2F, 1)));
